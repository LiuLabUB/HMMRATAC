...
2. [Overview of parameters](#overview-of-parameters)
3. [Overview of output files](#overview-of-output-files)
...
(described in [Section 2](#overview-of-parameters), under the ```-z ,
...
1. Java heap space error:
   ...
   ```--window``` option (See [section 2](#overview-of-parameters)).
...
gaps with no peaks:
   ...
   2](#overview-of-parameters)).  Lowering the ```-z``` option, will
...
peaks or the model shows NaN for all values:
   ...
   (see [section 3](#overview-of-output-files)) and see if the model is valid. A non-valid
   ...
   (see [section 2](#overview-of-parameters)). The default setting for

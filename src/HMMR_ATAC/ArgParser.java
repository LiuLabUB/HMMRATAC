...
public class ArgParser {
	...
	//Required inputs
		...
		public void printUsage(){
			...
			System.out.println("\t--window <int> Size of the bins to split the genome into for Viterbi decoding. To save memory, the genome is split into <int> long bins and viterbi decoding occurs across each bin. Default = 25000000. Note: For machines with limited memory, it is recomended to reduce the size of the bins.");
